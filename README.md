...
|:-:|---|:-:|:-:|:-:|---|
| ![](https://github.com/makerfaireczech.png?size=32) | **Dan Jirotka**<br><sub><a href="https://github.com/makerfaireczech">@makerfaireczech</a></sub> | 🔑 Admin | 44 | 2026-07-09 | V9 Ověřit režijní/nepřímé… |
...
- [přepis Plaud AI](./schuzky/2026-07-02-tydenni-schuzka-prepis-plaud.md)
</details>
...
## 🕓 Poslední aktivita&nbsp;⟳
<!-- AUTO:aktivita:start -->
- `ead6f42` 2026-07-09 · Dan Jirotka — Conserve (Phase A): archive superseded docs, consolidate project state
