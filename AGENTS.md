...
- **Nikdo jiný — Ondřej ani žádný agent — nevytváří vlastní/paralelní finanční čísla.** MM aktivity
  (`strategie/final-mm-zapojeni-a-aktivity.md`) přebírají čísla z Danova rozpočtu, **needefinují vlastní**.
